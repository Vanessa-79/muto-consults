    ...
    <div className="bg-white">
      ...
      <div className="relative">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center pt-20 pb-16 sm:pt-32 sm:pb-24">
            <h1 className="text-4xl font-extrabold text-white sm:text-5xl sm:tracking-tight lg:text-6xl">
              Connecting Top Talent with Great Opportunities
            </h1>
            <p className="mt-6 text-xl text-gray-300 max-w-md mx-auto">
              Join Muto Consults to find your dream job or the perfect candidate
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            ...
            <p className="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-navy-700 sm:text-4xl">
              What Makes Muto Consults Different
            </p>
            ...
            <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-3 md:gap-x-8 md:gap-y-10">
              ...
              <div className="relative">
                ...
                <div className="ml-16">
                  ...
                  <p className="mt-2 text-base text-gray-500">
                    Access to quality job listings, easy application process,
                    and professional interview scheduling.
                  </p>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <div className="ml-16">
                  ...
                  <p className="mt-2 text-base text-gray-500">
                    ...
                    qualified candidates efficiently.
                  </p>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <div className="ml-16">
                  ...
                  <p className="mt-2 text-base text-gray-500">
                    Safe payment processing, verified employers, and protected
